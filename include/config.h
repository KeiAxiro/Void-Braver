...
namespace Config
{
    namespace Paths
    {
        inline constexpr const char *GAME_DATA = "data/game_data.json";
        inline constexpr const char *SAVE_FILE = "data/save.json";
    }
    ...
    namespace Rules
    {
        ...
        inline constexpr int MIN_ENCOUNTERS_PER_MOVE = 1;
        inline constexpr int MAX_ENCOUNTERS_PER_MOVE = 3;
    ...
    namespace Player
    {
        ...
        inline constexpr double LEVEL_UP_MID_MULTIPLIER = 0.80;
        inline constexpr double LEVEL_UP_LATE_MULTIPLIER = 0.68;
        inline constexpr double LEVEL_UP_ENDGAME_MULTIPLIER = 0.58;
        inline constexpr int MINIMUM_EXP_REQUIREMENT = 80;
    }
